...
public class FragmentIndicator extends LinearLayout implements OnClickListener {
	...
	private void init() {
		...
		mIndicators[0] = createIndicator(R.drawable.tab_dial_selected,
				R.string.tab_dial, COLOR_SELECT, TAG_ICON_0, TAG_TEXT_0);
		mIndicators[0].setBackgroundResource(R.drawable.indic_select);
		mIndicators[0].setTag(Integer.valueOf(0));
		mIndicators[0].setOnClickListener(this);
		addView(mIndicators[0]);
		mIndicators[1] = createIndicator(R.drawable.tab_contact_normal,
				R.string.tab_contact, COLOR_UNSELECT, TAG_ICON_1, TAG_TEXT_1);
		mIndicators[1].setBackgroundColor(Color.alpha(0));
		mIndicators[1].setTag(Integer.valueOf(1));
		mIndicators[1].setOnClickListener(this);
		addView(mIndicators[1]);
		mIndicators[2] = createIndicator(R.drawable.tab_settings_normal,
				R.string.tab_personal, COLOR_UNSELECT, TAG_ICON_2, TAG_TEXT_2);
	...
	public static void setIndicator(int which) {
		...
		case 0:
			...
			prevIcon.setImageResource(R.drawable.tab_dial_normal);
		...
		case 1:
			...
			prevIcon.setImageResource(R.drawable.tab_contact_normal);
		...
		case 2:
			...
			prevIcon.setImageResource(R.drawable.tab_settings_normal);
		...
		case 0:
			...
			currIcon.setImageResource(R.drawable.tab_dial_selected);
		...
		case 1:
			...
			currIcon.setImageResource(R.drawable.tab_contact_selected);
		...
		case 2:
			...
			currIcon.setImageResource(R.drawable.tab_settings_selected);
